        ...
        return [
            GlobalPerimeter::new()
                ->allowed(function (Model $user, string $method) {
                    ...
                    dd([
                        '1_methode_lomkit' => $method,
                        '2_permission_requise' => $ability,
                        '3_user_a_le_droit' => $ability ? $user->hasPermissionTo($ability) : 'non testé',
                        '4_guard_du_user' => $user->guard_name ?? 'aucun'
                    ]);
